...
namespace ESD.Services.Common
{
    ...
    public class CommonDetailService : ICommonDetailService
    {
        ...
        public async Task<string> Create(CommonDetailDto model)
        {
            ...
            param.Add("@commonDetailCode", model.commonDetailCode?.ToUpper());
            param.Add("@commonDetailName", model.commonDetailName);
            param.Add("@commonDetailLanguge", model.commonDetailLanguge);
