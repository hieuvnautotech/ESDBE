...
namespace ESD.Services.Common
{
    public interface IMenuService
    {
        ...
        Task<ResponseModel<IEnumerable<MenuDto>?>> GetAllTreeMenu(long roleId, bool? forRoot);
    ...
    public class MenuService : IMenuService
    {
        ...
        public async Task<ResponseModel<IEnumerable<MenuDto>?>> GetAllTreeMenu(long roleId, bool? forRoot)
        {
            var returnData = new ResponseModel<IEnumerable<MenuDto>?>();
            var proc = $"sysUsp_Menu_GetAllForRole";
            var param = new DynamicParameters();
            param.Add("@roleId", roleId);
            param.Add("@forRoot", forRoot);
            var data = await _sqlDataAccess.LoadDataUsingStoredProcedure<MenuDto>(proc, param);
