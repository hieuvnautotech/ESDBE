...
namespace ESD.Services.Common
{
    public interface IRoleService
    {
        ...
        Task<string> SetMenuPermission(List<RoleMenuDto> roleList, long createdBy, long roleId);
    ...
    public class RoleService : IRoleService
    {
        ...
        public async Task<string> SetMenuPermission(List<RoleMenuDto> roleList, long createdBy, long roleId)
        {
            var jsonLotList = JsonConvert.SerializeObject(roleList);
