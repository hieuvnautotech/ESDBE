...
namespace ESD.Services.Common
{
    ...
    {
        Task<ResponseModel<IEnumerable<dynamic>?>> GetForSelect(string commonMasterCode);
    }
    ...
    public class CommonMasterService : ICommonMasterService
    {
        ...
        public async Task<string> Create(CommonMasterDto model)
        {
            ...
            param.Add("@commonMasterCode", model.commonMasterCode?.ToUpper());
        ...
        public async Task<ResponseModel<IEnumerable<dynamic>?>> GetForSelect(string commonMasterCode)
        {
